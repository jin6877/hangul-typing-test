...
> 자모(초성·중성·종성)를 분해해 **실제 타건수(KPM)**를 정확히 측정하는 한글 타이핑 속도 테스트
...
- ⌨️ **실시간 타수 측정** — 따라 치는 즉시 분당 타수(KPM)와 정확도가 갱신됩니다.
...
- 📚 **랜덤 지문 풀** — 한국어 명언·문장을 랜덤으로 제공하고, `Tab` 키 또는 버튼으로 다음 문장을 받을 수 있습니다.
- 📝 **짧은 글 / 긴 글 모드** — 난이도와 분량을 골라 연습할 수 있습니다.
- 🏆 **결과 리포트** — KPM / CPM(글자/분) / 영문 WPM / 정확도 / 걸린 시간을 한눈에.
- 💾 **최고 기록 저장** — `localStorage`에 모드별 최고 타수를 저장해 기록 갱신 시 알려줍니다.
